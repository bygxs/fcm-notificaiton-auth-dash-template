      ...
      <main className="flex flex-col gap-12 max-w-4xl w-full">
        ...
        <section className="prose dark:prose-invert max-w-none">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300">
            A production-ready Next.js 15 boilerplate with seamless dark mode implementation,
            system preference detection, and zero flicker guarantees.
          </p>
        </section>
              ...
              {[
                {
                  ...
                  description: "Powered by Zustand with automatic localStorage persistence. Toggle survives page reloads and browser restarts."
                },
                {
                  title: "🎨 Theming Engine",
                  description: "Utilizes Tailwind CSS dark mode classes with system preference fallback. No CSS-in-JS runtime overhead."
                },
                {
                  title: "⚡ Performance First",
                  description: "Theme applied before hydration using smart script injection. Zero flicker, perfect Lighthouse scores."
                }
              ].map((item, index) => (
            ...
            <ul className="space-y-4 text-gray-600 dark:text-gray-400">
              {[
                ...
                <li key={index} className="flex items-center gap-3">
                  <div className={`h-2 w-2 ${index % 2 === 0 ? 'bg-blue-500' : 'bg-purple-500'} rounded-full shrink-0`} />
                  <span>{feature}</span>
                </li>
              ))}
            </ul>
        ...
        <section className="prose dark:prose-invert max-w-none">
          ...
          <div className="p-4 rounded-lg bg-gray-50 dark:bg-gray-800">
            <code className="text-sm">
              npx create-next-app -e https://github.com/your-username/iii-dark-mode-nextjs
            </code>
          </div>
